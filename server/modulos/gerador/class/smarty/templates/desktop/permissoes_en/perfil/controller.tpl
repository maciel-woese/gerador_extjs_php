...
Ext.define('{$app|capitalize}.controller.Perfil', {
    ...
    edit: function(grid, record) {
    	...
    	me.getDesktopWindow('AddPerfilWin', 'Perfil', 'perfil.Edit', function(){
    		me.getAddWin().setTitle('Editing Profile');
    ...
    btdel: function(button) {
        ...
        if (me.getList().selModel.hasSelection()) {
			...
			Ext.Msg.confirm('Confirm', 'want to delete: '+record.get('perfil')+'?', function(btn){
				if(btn=='yes'){
    ...
    btStoreLoadFielter: function(button){
    	...
    	if(!win) var win = Ext.create('{$app|capitalize}.view.perfil.Filtro', {
