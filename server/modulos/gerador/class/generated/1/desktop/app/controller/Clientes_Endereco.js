...
Ext.define('ShSolutions.controller.Clientes_Endereco', {
	...
	refs: [
        {
        	ref: 'list',
        	selector: 'clientes_enderecolist gridpanel'
        },
        {
        	ref: 'form',
    ...
    init: function(application) {
    	this.control({
    		'clientes_enderecolist gridpanel': {                 
    ...
    edit: function(grid, record) {
    	var me = this;
		me.getDesktopWindow('AddClientes_EnderecoWin', 'Clientes_Endereco', 'clientes_endereco.Edit', function(){
    		me.getAddWin().setTitle('Edi&ccedil;&atilde;o de Clientes_Endereco');
	        me.getValuesForm(me.getForm(), me.getAddWin(), record.get('controle'), 'server/modulos/clientes_endereco/list.php');
    ...
    add: function(button) {
		var me = this;
        me.getDesktopWindow('Clientes_Endereco', 'Clientes_Endereco', 'clientes_endereco.Edit', false);
    },
