<?php
	class App {
		...
		public $arquivo = null;
		public $tabela	= null;
		public $dirApp  = 'class/generated/applicationDesktopMVC/';
		public $dirTpl  = 'class/smarty/templates/desktop/';
		public $dados 	= array();
		
		public function App($smarty, $tabela, $dados, $arquivo){
			$this->dirApp = "class/generated/{$_SESSION['id_usuario']}/desktop/";
		...
		public function varBr(){
			$this->smarty->assign('view_desktop', 'Mostrar Area de trabalho');
			$this->smarty->assign('title_preferences', 'Preferências');
			$this->smarty->assign('tree_auto_run', 'Inicialização automática');
			$this->smarty->assign('tree_quick_start', 'Inicialização rapida');
			$this->smarty->assign('tree_icon_desktop', 'Icones área de trabalho');
			$this->smarty->assign('tree_start_menu', 'Menu Iniciar');
		...
		*	@return Arquivos de Controles Gerados
		*/
		public function createControllerPrincipal(){
			//create Controller Desktop
			$this->smarty->assign('app', $this->dados['app']);
			$l = $this->smarty->fetch($this->dirTpl.'controller/Desktop.tpl');
			$file = $this->dirApp."app/controller/Desktop.js";
			$arq = fopen($file,"w");
			fwrite($arq, $l);
			fclose($arq);
			...
			//create view Desktop
			$this->smarty->assign('app', $this->dados['app']);
			$l = $this->smarty->fetch($this->dirTpl.'view/Desktop.tpl');
			$file = $this->dirApp."app/view/Desktop.js";
			$arq = fopen($file,"w");
			fwrite($arq, $l);
			fclose($arq);
			
			//create Controller Util
			$this->smarty->assign('app', $this->dados['app']);
		...
		*/
		...
		public function createCss(){
			...
			$file = $this->dirApp."resources/css/icons.css";
