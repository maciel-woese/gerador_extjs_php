<?php /* Smarty version Smarty-3.1.8, created on 2013-09-27 09:46:12
         compiled from "class/smarty/templates/desktop/permissoes_br/permissoes/class.tpl" */ ?>
<?php /*%%SmartyHeaderCode:156431118152457e1437c768-01532556%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '7e01b6f8eb48d6c3066899fde3483df171af31b8' => 
    array (
      0 => 'class/smarty/templates/desktop/permissoes_br/permissoes/class.tpl',
      1 => 1380126225,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '156431118152457e1437c768-01532556',
  'function' => 
  array (
  ),
  'has_nocache_code' => false,
  'version' => 'Smarty-3.1.8',
  'unifunc' => 'content_52457e14401cb8_61762646',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_52457e14401cb8_61762646')) {function content_52457e14401cb8_61762646($_smarty_tpl) {?><<?php ?>?php
	class Permissoes{
		private $sql;
		private $perfil_id = 0;
			...
			foreach($modulos as $key => $row){
				...
				if(isset($permissoes[$key])){
					foreach($row as $r1){
						...
						if(isset($rr['acesso']) and $rr['acesso']=='S' and $rr['perfil_id']=='0') $cor = 'green';
						else if(isset($rr['acesso']) and $rr['acesso']=='N' and $rr['perfil_id']=='1') $cor = 'red';
						else $cor = 'black';
						$nome = $r1['text'];
						$r1['text'] = "<span style='color: $cor'>$nome</span>"; 
