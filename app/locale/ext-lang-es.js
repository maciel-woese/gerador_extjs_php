Ext.onReady(function() {
	Ext.define("Ext.locale.en.gerador.List", {
		...
		colNomeCampo: 'Nombre del campo',
		
		colPrimaryKey: 'Clave Principal',
		colUniqueKey: 'Clave Únicay',
		colForeignKey: 'Clave Externa',
		
		colTabRef: 'Tabla Ref.',
		colRefValue: 'Col. Ref. Valor',
		colRefLabel: 'Col. Ref. Etiqueta',
		
		colTipoCondicao: 'Tipo Condición',
		colValorCondicao: 'Valor Condición',
		
		editorTrue: 'Verdadero',
		editorFalse: 'Falso',
		editorCondicao: {
			combo: 'Combobox',
			mask: 'Máscara',
		...
		buttonLoginBanco: 'Entre DataBase <b>Ctrl+L</b>',
		buttonSelectTab: 'Seleccionar tablas <b>Shift+T</b>',
		buttonPrepareCrud: 'Prepárese para Generar <b>Shift+P</b>', //#PAREI AQUI
